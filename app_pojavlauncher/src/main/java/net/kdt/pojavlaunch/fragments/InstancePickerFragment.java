...
public class InstancePickerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (profiles != null) {
            for (Map.Entry<String, MinecraftProfile> entry : LauncherProfiles.getOrderedEntries()) {
        ...
        recycler.setAdapter(new InstanceAdapter(keys, profiles, profileAdapter, selected,
                ...
                () -> {
                    // "New instance" tapped — open the creation-type chooser
                    // (Normal Version / Client / Mod Pack). The dialog itself
                    // routes into the right pane or full-screen as appropriate.
                    CreationTypeDialog.show(InstancePickerFragment.this);
                }));
    }
